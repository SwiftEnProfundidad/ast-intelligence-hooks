...
const equivalentRuleFamilies: ReadonlyArray<ReadonlyArray<string>> = [
  ...
  ['skills.ios.no-foreach-indices', 'heuristics.ios.foreach-indices.ast'],
  ['skills.ios.no-contains-user-filter', 'heuristics.ios.contains-user-filter.ast'],
  ['skills.ios.no-geometryreader', 'heuristics.ios.geometryreader.ast'],
  ['skills.ios.no-font-weight-bold', 'heuristics.ios.font-weight-bold.ast'],
  [
    'skills.ios.no-scrollview-shows-indicators',
    'heuristics.ios.scrollview-shows-indicators.ast',
  ],
  ['skills.ios.no-sheet-is-presented', 'heuristics.ios.sheet-is-presented.ast'],
  ['skills.ios.no-legacy-onchange', 'heuristics.ios.legacy-onchange.ast'],
  ...
  ['skills.ios.prefer-swift-testing', 'heuristics.ios.testing.xctest-suite-modernizable.ast'],
  ...
  ['skills.ios.no-core-data-layer-leak', 'heuristics.ios.core-data.layer-leak.ast'],
  [
