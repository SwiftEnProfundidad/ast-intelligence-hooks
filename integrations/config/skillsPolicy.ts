...
const normalizedBundlePolicy = (value: SkillsBundlePolicy): Record<string, string | number | boolean | bigint | symbol | null | Date | object> => {
  return {
...
const normalizedPolicyForHash = (policy: SkillsPolicyV1): Record<string, string | number | boolean | bigint | symbol | null | Date | object> => {
