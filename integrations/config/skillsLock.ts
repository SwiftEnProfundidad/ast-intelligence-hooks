...
const normalizedRuleForHash = (rule: SkillsCompiledRule): Record<string, string | number | boolean | bigint | symbol | null | Date | object> => {
  return {
    id: rule.id,
...
const normalizedBundleForHash = (bundle: SkillsLockBundle): Record<string, string | number | boolean | bigint | symbol | null | Date | object> => {
...
const normalizedLockForHash = (lock: SkillsLockV1): Record<string, string | number | boolean | bigint | symbol | null | Date | object> => {
