...
export const createFrameworkMenuDiagnosticsSupportCoreActions = (
  ...
  return [
    {
      id: '13',
      label: 'Toolkit: build consumer startup-failure support bundle',
      execute: async () => {
    ...
    {
      id: '14',
      label: 'Toolkit: build consumer support ticket draft',
      execute: async () => {
    ...
    {
      id: '15',
      label: 'Toolkit: build consumer startup-unblock status report',
      execute: async () => {
