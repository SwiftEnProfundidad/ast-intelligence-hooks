...
EvidenceMonitor.prototype.isPidRunning = function isPidRunning(pid) {
...
EvidenceMonitor.prototype.acquireRefreshLock = function acquireRefreshLock() {
    try {
...
EvidenceMonitor.prototype.releaseRefreshLock = function releaseRefreshLock() {
    try {
...
EvidenceMonitor.prototype.resolveUpdateEvidenceScript = function resolveUpdateEvidenceScript() {
    const candidates = [
...
EvidenceMonitor.prototype.isStale = function isStale() {
    try {
...
EvidenceMonitor.prototype.refresh = async function refresh() {
...
EvidenceMonitor.prototype.startPolling = function startPolling(onStale, onRefreshed) {
...
EvidenceMonitor.prototype.stop = function stop() {
    if (this.pollTimer) {
