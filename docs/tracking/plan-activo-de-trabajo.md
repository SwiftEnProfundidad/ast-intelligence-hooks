...
3. 🚧 **RuralGO (producto) — ejecución release `develop` → `main`**: **foco actual**. Charter en [`DEVELOP_TO_MAIN_RELEASE_CHARTER.md`](https://github.com/SwiftEnProfundidad/R_GO/blob/develop/docs/technical/06-ci-cd/DEVELOP_TO_MAIN_RELEASE_CHARTER.md) (PRs doc **#1627**, **#1628**, **#1630** **MERGED**). **Rama [`release/1.0.1`](https://github.com/SwiftEnProfundidad/R_GO/tree/release/1.0.1)** sincronizada con `develop`; [**PR #1629** — **borrador** → `main`](https://github.com/SwiftEnProfundidad/R_GO/pull/1629) (cuerpo del PR: checklist + SHA al abrir corte). **Punta `origin/develop` (referencia de sesión):** `cf94fb5a3251315643d9526d2a684c8ebbd10fae` — siempre preferir `git rev-parse origin/develop` al cerrar evidencias. **No fusionar** hasta owner nominal + checklist marcado. **Semver `1.0.1`:** validar con criterio de producto (nombre de rama/PR provisional).
