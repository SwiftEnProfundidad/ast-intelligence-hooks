...
- Frente activo: `rollout-6.3.69-consumers`
...
- Línea **6.3.69** (npm): modal macOS + `gate.blocked` stderr + git-flow/worktree en hooks; **6.3.68** PRE_WRITE encadenado + adapter por defecto; **6.3.65+** orden con pre-commit.com + `exec`.
