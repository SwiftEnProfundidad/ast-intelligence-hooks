...
- Línea **6.3.65** en npm (`npm view pumuki version` → **6.3.65** @latest); repin consumidores y **`pumuki install`** para reescribir `.git/hooks/pre-commit` (fix orden con pre-commit.com + `exec`).
