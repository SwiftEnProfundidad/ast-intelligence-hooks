...
3. 🚧 **RuralGO (producto) — ejecución release `develop` → `main`**: **foco actual**. Charter (PRs doc **#1627–#1631**; [**#1631**](https://github.com/SwiftEnProfundidad/R_GO/pull/1631) **MERGED**). **Alineación doc SHA en charter:** [**#1632**](https://github.com/SwiftEnProfundidad/R_GO/pull/1632) **MERGED** a `develop` (**2026-04-12**, tabla + viñeta 2026-04-12 ↔ tip `a93b868c9…`). **Rama [`release/1.0.1`](https://github.com/SwiftEnProfundidad/R_GO/tree/release/1.0.1)** en fast-forward con `develop`; [**PR #1629** — **borrador** → `main`](https://github.com/SwiftEnProfundidad/R_GO/pull/1629) — checklist **sigue abierto**; evidencia parcial ya en comentarios (`pumuki doctor`, sync release). **Punta `origin/develop`:** ejecutar `git rev-parse origin/develop` tras `git pull` antes de cerrar checklist. **No fusionar #1629** hasta owner nominal + ítems del charter marcados con evidencia. **Semver `1.0.1`:** validar con producto.
