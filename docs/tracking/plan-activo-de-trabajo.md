...
3. 🚧 **RuralGO (producto) — ejecución release `develop` → `main`**: **foco actual**. Charter + tabla en [`DEVELOP_TO_MAIN_RELEASE_CHARTER.md`](https://github.com/SwiftEnProfundidad/R_GO/blob/develop/docs/technical/06-ci-cd/DEVELOP_TO_MAIN_RELEASE_CHARTER.md) **actualizado 2026-04-12** vía [PR **#1627**](https://github.com/SwiftEnProfundidad/R_GO/pull/1627) (**MERGED**): punta documental **`7383e8112`** / referencia **`c4e8aec23`** post-repin Pumuki **6.3.72**; checklist de salida **sigue sin marcar**; merge a **`main` sigue prohibido** hasta owner nominal + evidencias. **Hacer ahora:** (1) **nombrar owner + backup** en el charter, (2) **crear `release/<semver>`** desde el SHA vigente, (3) **marcar checklist** con evidencia (CI/Vercel/Pumuki/etc.), (4) PR/revisión hacia `main`.
