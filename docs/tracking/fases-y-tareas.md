...
- 🚧 `P2.F1.T3` Sanear `UX / Reporting` del consumer, empezando por `workflow lint`, `skills tooling` y `adapter diagnostics`, para que los comandos de soporte fallen limpio, no emitan stacktraces crudos y degraden de forma explicable cuando falten dependencias opcionales o artefactos del consumer.
