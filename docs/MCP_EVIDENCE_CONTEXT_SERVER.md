...
- `GET /ai-evidence/summary`: compact deterministic summary (`stage/outcome/has_findings/counts/severity_counts/findings_by_platform/highest_severity/blocking_findings_count/ledger_by_platform/rulesets_by_platform/rulesets_fingerprint/detected_platforms_count/detected platforms`)
