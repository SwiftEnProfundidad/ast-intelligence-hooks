...
- `GET /ai-evidence/summary`: compact deterministic summary (`stage/outcome/has_findings/counts/severity_counts/findings_by_platform/highest_severity/ledger_by_platform/rulesets_by_platform/detected_platforms_count/detected platforms`)
...
- `GET /status`: lightweight summary (`present/valid/version/stage/outcome/has_findings/counts/severity_counts/findings_by_platform/highest_severity/ledger_by_platform/rulesets_by_platform/detected_platforms_count`) plus `context_api` capabilities (`endpoints`, supported filters, deterministic pagination bounds)
