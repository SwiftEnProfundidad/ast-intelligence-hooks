...
- Última task cerrada (`✅`): PUMUKI-111 (issue `#696`, `next_commands` estructurado para consumers JSON).
- Task activa (`🚧`): PUMUKI-112 (issue `#697`, `next_commands[].safety` para orquestadores).
