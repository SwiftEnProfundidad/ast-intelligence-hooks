...
- Última task cerrada (`✅`): PUMUKI-088 (issue `#673`, enlace directo a sección backlog tooling en `docs/USAGE.md`).
- Task activa (`🚧`): PUMUKI-089 (issue `#674`, estabilizar anchor de sección backlog tooling).
