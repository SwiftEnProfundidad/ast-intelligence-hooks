...
- Task activa (`🚧`): `P12.F1.T42` (sincronizar canónico RuralGO tras cierre de `#543`; commit documental listo en `R_GO` y pendiente push por gate de skills en rama histórica).
