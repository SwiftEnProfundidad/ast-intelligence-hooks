...
- Última task cerrada (`✅`): PUMUKI-081 (issue `#666`, añadir bloque `compat` al contrato JSON).
- Task activa (`🚧`): PUMUKI-082 (issue `#667`, añadir `compat.is_backward_compatible` al contrato JSON).
