...
- Última task cerrada (`✅`): PUMUKI-097 (issue `#682`, `classification_counts` en JSON de backlog tooling).
- Task activa (`🚧`): PUMUKI-098 (issue `#683`, `action_required_reasons` en JSON).
