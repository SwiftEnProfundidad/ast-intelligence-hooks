...
- Última task cerrada (`✅`): PUMUKI-096 (issue `#681`, `heading_changes_count` en JSON de reconcile).
- Task activa (`🚧`): PUMUKI-097 (issue `#682`, `classification_counts` en JSON de backlog tooling).
