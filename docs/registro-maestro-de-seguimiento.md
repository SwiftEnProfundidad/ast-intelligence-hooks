...
- Última task cerrada (`✅`): PUMUKI-115 (issue `#700`, `next_commands[].depends_on` para secuenciación).
- Task activa (`🚧`): PUMUKI-116 (issue `#701`, `next_commands[].idempotent` por paso).
