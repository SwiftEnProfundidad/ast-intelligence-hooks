...
- Última task cerrada (`✅`): PUMUKI-078 (issue `#663`, añadir `generated_at` al contrato JSON de backlog tooling).
- Task activa (`🚧`): PUMUKI-079 (issue `#664`, añadir `run_id` al contrato JSON de backlog tooling).
