...
- `docs/validation/skills-rollout-r_go-ci-artifacts-scan.md` (automated run/artifact scan generated by framework helper)
- `docs/validation/skills-rollout-r_go-workflow-lint.md` (semantic workflow lint findings linked to startup-failure triage)
- `docs/validation/skills-rollout-r_go-workflow-lint-auto.md` (automated workflow lint report generated by framework helper)
- `docs/validation/skills-rollout-r_go-startup-fix-experiment.md` (branch-only remediation test outcome)
- `docs/validation/private-actions-healthcheck-temp.md` (account-level private Actions reproduction evidence)
- `docs/validation/skills-rollout-r_go-support-bundle.md` (support-ready diagnostic payload for escalation)
