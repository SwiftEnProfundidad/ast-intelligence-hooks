...
## Sondeo #6 de seguimiento externo (2026-02-23)

PR usada para muestra más reciente:

- `https://github.com/SwiftEnProfundidad/ast-intelligence-hooks/pull/387`
...
- CI (`job 64561104978`) -> `runner_id=0`, `steps=[]`
- Android gate (`job 64561097458`) -> `runner_id=0`, `steps=[]`
- package-smoke minimal (`job 64561127395`) -> `runner_id=0`, `steps=[]`

Evidencia:

- `.audit_tmp/p-adhoc-lines-015-pr-387-status.json`
- `.audit_tmp/p-adhoc-lines-015-pr-387-checks.json`
- `.audit_tmp/p-adhoc-lines-015-pr387-ci-job.json`
- `.audit_tmp/p-adhoc-lines-015-pr387-android-job.json`
- `.audit_tmp/p-adhoc-lines-015-pr387-package-minimal-job.json`

## Sondeo #7 de seguimiento externo (2026-02-23)

PR usada para muestra más reciente:

- `https://github.com/SwiftEnProfundidad/ast-intelligence-hooks/pull/388`
...
- CI (`job 64563563501`) -> `runner_id=0`, `steps=[]`
- Android gate (`job 64563580330`) -> `runner_id=0`, `steps=[]`
- package-smoke minimal (`job 64563572042`) -> `runner_id=0`, `steps=[]`

Evidencia:

- `.audit_tmp/p-adhoc-lines-015-pr-388-status.json`
- `.audit_tmp/p-adhoc-lines-015-pr-388-checks.json`
...
## Sondeo #9 de seguimiento externo (2026-02-23)

PR usada para muestra más reciente:

- `https://github.com/SwiftEnProfundidad/ast-intelligence-hooks/pull/390`
...
- CI (`job 64565936100`) -> `runner_id=0`, `steps=[]`
- Android gate (`job 64565926785`) -> `runner_id=0`, `steps=[]`
- package-smoke minimal (`job 64565936119`) -> `runner_id=0`, `steps=[]`

Evidencia:

- `.audit_tmp/p-adhoc-lines-015-pr-390-status.json`
- `.audit_tmp/p-adhoc-lines-015-pr-390-checks.json`
