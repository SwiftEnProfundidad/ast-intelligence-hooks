...
- [ ] MCP context summary/status now expose deterministic `suppressed_replacement_reason_rule_file_platform_quadruples_count` for replacement reason/rule/file/platform suppression triage.
