...
- [ ] MCP context summary/status now expose deterministic `suppressed_share_triage_stream_signal_family_trace_code` for suppression-share triage stream-signal-family-trace-code rollup.
