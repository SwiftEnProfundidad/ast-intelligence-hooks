...
- [ ] MCP context summary/status now expose deterministic `suppressed_replacement_rule_file_platform_share_of_total_pct` for replacement rule/file/platform share triage.
