...
- [ ] MCP context summary/status now expose deterministic `suppressed_replacement_split_mode_replacement_count` for replacement-mode replacement bucket triage.
