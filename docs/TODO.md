...
- [ ] MCP context summary/status now expose deterministic `suppressed_reason_rule_file_platform_replacement_split_count` for replacement-vs-non-replacement suppression split triage.
