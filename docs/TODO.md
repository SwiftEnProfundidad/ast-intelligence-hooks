...
- [ ] MCP context summary/status now expose deterministic `suppressed_reason_rule_file_platform_quadruples_count` for reason/rule/file/platform suppression triage.
