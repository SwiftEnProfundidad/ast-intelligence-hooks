...
- [ ] MCP context summary/status now expose deterministic `suppressed_non_replacement_rule_file_platform_share_of_total_pct` for non-replacement rule/file/platform share triage.
