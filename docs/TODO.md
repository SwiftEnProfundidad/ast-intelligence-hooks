...
- [ ] MCP context summary/status now expose deterministic `suppressed_non_replacement_reason_platform_pairs_count` for non-replacement reason/platform suppression pair triage.
