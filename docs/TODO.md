...
- [ ] MCP context summary/status now expose deterministic `suppressed_replacement_reason_platform_pairs_count` for replacement reason/platform suppression pair triage.
