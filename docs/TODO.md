...
- [ ] MCP context summary/status now expose deterministic `suppressed_replacement_split_mode_non_replacement_count` for replacement-mode non-replacement bucket triage.
