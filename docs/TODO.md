...
- [ ] MCP context summary/status now expose deterministic `suppressed_non_replacement_rule_file_platform_distinct_count` for non-replacement rule/file/platform distinct triage.
