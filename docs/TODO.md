...
- [ ] MCP context summary/status now expose deterministic `suppressed_replacement_reason_rule_platform_triples_count` for replacement reason/rule/platform suppression triage.
