...
- [ ] MCP context summary/status now expose deterministic `suppressed_share_triage_stream_signal_family_weight` for suppression-share triage stream-signal-family-weight rollup.
