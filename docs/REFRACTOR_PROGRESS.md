...
- 🚧 Añadir cobertura unitaria del Batch 03 y validar en local (avance: ✅ `integrations/mcp/evidenceFacetsPlatforms.ts`, ✅ `integrations/mcp/evidenceFacetsFindings.ts`; pendiente: `integrations/sdd/index.ts`).
