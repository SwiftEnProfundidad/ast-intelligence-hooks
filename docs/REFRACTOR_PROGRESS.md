...
- 🚧 Continuar siguiente bloque post-release: preparar fix atómico en `pumuki-mock-consumer/scripts/run-pumuki-matrix.sh` para bootstrap explícito de OpenSpec en clone interno y recuperar matriz determinista sin workaround manual.
