...
- 🚧 Añadir cobertura unitaria del Batch 01 y validar en local (avance: ✅ `integrations/platform/detectPlatforms.ts`, ✅ `integrations/mcp/evidenceContextServer.ts`; pendiente: `integrations/gate/stagePolicies.ts`).
