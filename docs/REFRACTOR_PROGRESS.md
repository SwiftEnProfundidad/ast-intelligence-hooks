...
- 🚧 Abrir siguiente bloque post-release: preparar paquete de cierre/hand-off del mock (`resumen operativo + comandos reproducibles + criterios de salida`) para continuar con nuevas rondas de validación sin deriva.
