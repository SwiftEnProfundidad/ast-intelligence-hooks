...
- 🚧 Añadir cobertura unitaria del Batch 01 y validar en local (avance: ✅ `integrations/platform/detectPlatforms.ts`; pendientes: `integrations/gate/stagePolicies.ts`, `integrations/mcp/evidenceContextServer.ts`).
