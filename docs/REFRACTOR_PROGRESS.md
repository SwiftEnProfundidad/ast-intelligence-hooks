...
- 🚧 Añadir cobertura unitaria del Batch 04 y validar en local (avance: ✅ `integrations/mcp/evidencePayloadSummary.ts`, ✅ `integrations/mcp/evidenceFacets.ts`; pendiente: `integrations/mcp/evidenceFacetsLedger.ts`).
