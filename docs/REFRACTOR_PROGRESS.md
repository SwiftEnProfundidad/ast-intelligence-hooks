...
- 🚧 Añadir cobertura unitaria del Batch 06 y validar en local (avance: ✅ `integrations/mcp/evidenceFacetsSuppressedShare.ts`; pendientes: `integrations/git/index.ts`, `integrations/mcp/evidenceContextServer.cli.ts`).
