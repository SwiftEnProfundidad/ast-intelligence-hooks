...
- 🚧 Añadir cobertura unitaria del Batch 07 y validar en local (avance: ✅ `integrations/mcp/enterpriseServer.cli.ts`; pendientes: `integrations/mcp/evidenceFacetsSnapshot.ts`, `integrations/mcp/evidenceFacetsBase.ts`).
