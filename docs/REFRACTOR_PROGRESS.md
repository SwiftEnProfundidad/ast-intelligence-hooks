...
- 🚧 Añadir cobertura unitaria del Batch 06 y validar en local (avance: ✅ `integrations/mcp/evidenceFacetsSuppressedShare.ts`, ✅ `integrations/git/index.ts`; pendiente: `integrations/mcp/evidenceContextServer.cli.ts`).
