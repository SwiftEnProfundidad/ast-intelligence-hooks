...
- 🚧 Añadir cobertura unitaria del Batch 05 y validar en local (avance: ✅ `integrations/platform/detectFrontend.ts`; pendientes: `integrations/platform/detectAndroid.ts`, `integrations/platform/detectBackend.ts`).
