...
- 🚧 Añadir cobertura unitaria del Batch 03 y validar en local (avance: ✅ `integrations/mcp/evidenceFacetsPlatforms.ts`; pendientes: `integrations/mcp/evidenceFacetsFindings.ts`, `integrations/sdd/index.ts`).
