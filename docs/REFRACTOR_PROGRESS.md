...
- 🚧 Añadir cobertura unitaria del Batch 02 y validar en local (pendientes: `integrations/mcp/evidencePayloadConfig.ts`, `integrations/sdd/types.ts`, `integrations/mcp/evidenceFacetsRulesets.ts`).
