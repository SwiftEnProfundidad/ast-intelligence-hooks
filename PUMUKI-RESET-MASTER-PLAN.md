...
Tarea activa única: `[🚧] - Repriorización interna post-S2.c — Seleccionar siguiente corte contractual` con el backlog externo ya en `0` y `S2.c` cerrado, la siguiente tarea inmediata vuelve a ser fijar el próximo slice interno con criterio de superficie mínima, sin reabrir frentes paralelos ni mezclar tracking con cambios funcionales no priorizados.
