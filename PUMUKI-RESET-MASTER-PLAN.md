...
Último avance operativo: `[🚧] - PARITY-IOS-001 / Dependencias iOS brownfield-aware - CocoaPods y Carthage` mantiene la prioridad iOS antes de volver a Android, Frontend y Backend. Slice activa: Swift Package Manager queda como baseline preferente; Podfile/Cartfile se detectan como heurísticas WARN para controlar drift nuevo sin bloquear deuda histórica brownfield salvo promoción explícita de policy.
