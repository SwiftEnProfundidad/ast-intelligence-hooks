...
Tarea activa única: `[🚧] - PUMUKI-INC-086 — Alinear stage y snapshot de evidencia en la salida visible` con `081/083/084/089` ya cerradas en la línea publicada y en RuralGo; la salida seguía mezclando `governanceNextAction.stage` con un `snapshot_stage` distinto en el bootstrap manifest, así que el objetivo inmediato es cerrar esa incoherencia de contrato antes de abrir otro frente.
