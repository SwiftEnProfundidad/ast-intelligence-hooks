...
|-----------|-----------------|
| Este plan | [🚧] - `PARITY-ANDROID-001` / Baseline Android restante por AST real. Estado 2026-05-05: los bugs externos activos quedan a 0 tras cerrar `PUMUKI-INC-127` en `pumuki@6.3.153` y repinear primero RuralGo; se mantiene la paridad Android abierta mientras queden reglas declarativas del lock sin cobertura equivalente por nodos/preset. |
