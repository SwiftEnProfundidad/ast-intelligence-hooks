...
- [🚧] - `PARITY-IOS-001` / `skills.ios.no-dispatchsemaphore` / detector AST real para sincronización GCD legacy: continuar paridad iOS con nodos accionables y fix hacia `TaskGroup`, `AsyncStream` o boundaries async explícitos.
...
- Estado: ✅ PUMUKI-INC-143 cerrado en `pumuki@6.3.252`; sin bugs externos abiertos conocidos tras el repin RuralGo. Task iOS actual: ✅ `skills.ios.no-dispatchgroup` preparado para `pumuki@6.3.266`; siguiente 🚧 `skills.ios.no-dispatchsemaphore`.
