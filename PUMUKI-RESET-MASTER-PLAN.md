...
- [🚧] - `PARITY-IOS-001` / `skills.ios.no-dispatchgroup` / detector AST real para coordinación GCD legacy: continuar paridad iOS con nodos accionables y fix hacia `TaskGroup` o concurrencia estructurada.
