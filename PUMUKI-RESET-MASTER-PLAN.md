...
Último avance operativo: `[🚧] - PARITY-IOS-001 / Seguridad iOS brownfield-aware - secretos en UserDefaults/AppStorage` mantiene la prioridad iOS antes de volver a Android, Frontend y Backend. Slice activa: Keychain nativo queda como baseline preferente; UserDefaults/AppStorage con tokens, passwords o secretos se detecta como heurística WARN para controlar drift nuevo sin bloquear deuda histórica brownfield salvo promoción explícita de policy.
