...
- [🚧] - `PARITY-IOS-001` / `skills.ios.no-force-unwrap` / detector AST real para force unwrap Swift: continuar paridad iOS con nodos accionables y fix hacia unwrap seguro.
...
|-----------|-----------------|
| Este plan | `[✅] - PUMUKI-INC-143` cerrado; `[✅] - PARITY-IOS-001 / skills.ios.no-wait-for-expectations` publicado en `pumuki@6.3.253`; `[✅] - PARITY-IOS-001 / skills.ios.no-legacy-expectation-description` publicado en `pumuki@6.3.254`; `[✅] - PARITY-IOS-001 / skills.ios.no-mixed-testing-frameworks` publicado en `pumuki@6.3.255`; `[✅] - PARITY-IOS-001 / skills.ios.guideline.ios.quick-nimble-prohibido-usar-swift-testing-nativo` publicado en `pumuki@6.3.256`; `[✅] - PARITY-IOS-001 / skills.ios.no-xctassert` publicado en `pumuki@6.3.257`; `[✅] - PARITY-IOS-001 / skills.ios.no-xctunwrap` publicado en `pumuki@6.3.258`; `[✅] - PARITY-IOS-001 / skills.ios.prefer-swift-testing` preparado para `pumuki@6.3.259`; `[🚧] - PARITY-IOS-001 / skills.ios.no-force-unwrap` queda como siguiente detector iOS. |

- Estado: ✅ PUMUKI-INC-143 cerrado en `pumuki@6.3.252`; sin bugs externos abiertos conocidos tras el repin RuralGo. Task iOS actual: ✅ `skills.ios.prefer-swift-testing` preparado para `pumuki@6.3.259`; siguiente 🚧 `skills.ios.no-force-unwrap`.
