...
Último avance operativo: `[🚧] - PARITY-IOS-001 / Continuación iOS - reglas pendientes de baseline Swift/iOS` mantiene la prioridad iOS antes de volver a Android, Frontend y Backend. Siguiente slice: seleccionar la próxima regla iOS no mapeada desde `skills.lock.json` y materializarla con detector, extractor, preset, registry, tests, documentación y release útil si aporta valor a consumers.
