...
- [🚧] - `PARITY-IOS-001` / `skills.ios.guideline.ios.quick-nimble-prohibido-usar-swift-testing-nativo` / detector AST real para Quick/Nimble legacy: continuar paridad Swift Testing con nodos accionables y sin enforcement declarativo.
...
|-----------|-----------------|
| Este plan | `[✅] - PUMUKI-INC-143` cerrado; `[✅] - PARITY-IOS-001 / skills.ios.no-wait-for-expectations` publicado en `pumuki@6.3.253`; `[✅] - PARITY-IOS-001 / skills.ios.no-legacy-expectation-description` publicado en `pumuki@6.3.254`; `[✅] - PARITY-IOS-001 / skills.ios.no-mixed-testing-frameworks` preparado para `pumuki@6.3.255`; `[🚧] - PARITY-IOS-001 / skills.ios.guideline.ios.quick-nimble-prohibido-usar-swift-testing-nativo` queda como siguiente detector Swift Testing. |

- Estado: ✅ PUMUKI-INC-143 cerrado en `pumuki@6.3.252`; sin bugs externos abiertos conocidos tras el repin RuralGo. Task iOS actual: ✅ `skills.ios.no-mixed-testing-frameworks` preparado para `pumuki@6.3.255`; siguiente 🚧 `skills.ios.guideline.ios.quick-nimble-prohibido-usar-swift-testing-nativo`.
