...
Tarea activa única: `[🚧] - Repriorización interna post-S2 — Seleccionar siguiente corte contractual` con el backlog externo ya en `0` y `S2.b` cerrado, la siguiente tarea inmediata pasa a ser fijar el próximo slice interno con el mismo criterio de superficie mínima, evitando reabrir frentes paralelos o volver a mezclar tracking con trabajo no priorizado.
