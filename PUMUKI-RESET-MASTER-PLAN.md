...
|-----------|-----------------|
| Este plan | [🚧] - `PARITY-IOS-001` / cerrar todas las skills iOS como AST Intelligence por nodos. Estado 2026-05-05: los bugs externos activos quedan a 0 y el lock actual confirma `iOS total=318`, `AUTO=63`, `DECLARATIVE=255`; por impacto real en RuralGo y en los proyectos iOS del owner, iOS queda por delante de Android hasta convertir o justificar todas sus reglas declarativas con cobertura AST/preset/registry/test/lock. |
