...
Último avance operativo: `[🚧] - PARITY-IOS-001 / Networking y JSON iOS brownfield-aware` mantiene la prioridad iOS antes de volver a Android, Frontend y Backend. Slice activa: URLSession/Codable quedan como baseline preferente; Alamofire y JSONSerialization se detectan como heurísticas WARN para evitar drift nuevo sin bloquear deuda histórica brownfield salvo promoción explícita de policy.
