...
- [🚧] - `PARITY-IOS-001` / `skills.ios.no-anyview` / detector AST real para `AnyView` SwiftUI: continuar paridad iOS con nodos accionables y fix hacia composición tipada.
