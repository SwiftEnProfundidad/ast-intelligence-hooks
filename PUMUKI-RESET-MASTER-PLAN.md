...
- [🚧] - `PARITY-IOS-001` / `skills.ios.no-mixed-testing-frameworks` / detector AST real para mezcla XCTest + Swift Testing en el mismo archivo: continuar paridad Swift Testing con nodos accionables y sin enforcement declarativo.
...
|-----------|-----------------|
| Este plan | `[✅] - PUMUKI-INC-143` cerrado; `[✅] - PARITY-IOS-001 / skills.ios.no-wait-for-expectations` publicado en `pumuki@6.3.253`; `[✅] - PARITY-IOS-001 / skills.ios.no-legacy-expectation-description` preparado para `pumuki@6.3.254`; `[🚧] - PARITY-IOS-001 / skills.ios.no-mixed-testing-frameworks` queda como siguiente detector Swift Testing. |

- Estado: ✅ PUMUKI-INC-143 cerrado en `pumuki@6.3.252`; sin bugs externos abiertos conocidos tras el repin RuralGo. Task iOS actual: ✅ `skills.ios.no-legacy-expectation-description` preparado para `pumuki@6.3.254`; siguiente 🚧 `skills.ios.no-mixed-testing-frameworks`.
