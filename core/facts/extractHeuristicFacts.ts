...
const hasTlsEnvRejectUnauthorizedZeroOverride = (node: unknown): boolean => {
...
const hasFsStatfsSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsAccessSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsUtimesSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsReadlinkSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsSymlinkSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsLinkSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsCpSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsOpenSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasFsOpendirSyncCall = (node: unknown): boolean => {
  return hasNode(node, (value) => {
    if (value.type !== 'CallExpression') {
      return false;
    }
...
const hasChildProcessShellTrueCall = (node: unknown): boolean => {
...
export const extractHeuristicFacts = (
  ...
  for (const fact of params.facts) {
    ...
    try {
      ...
      if (hasTlsEnvRejectUnauthorizedZeroOverride(ast)) {
        heuristicFacts.push(
          createHeuristicFact({
      ...
      if (hasChildProcessShellTrueCall(ast)) {
        heuristicFacts.push(
          createHeuristicFact({
