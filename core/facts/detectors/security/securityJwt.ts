...
const isJwtDecodeWithoutVerifyCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
...
const isJwtVerifyIgnoreExpirationCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
  if (value.type !== 'CallExpression') {
    return false;
  }
...
const isJwtSignWithoutExpirationCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
  if (value.type !== 'CallExpression') {
    return false;
  }
