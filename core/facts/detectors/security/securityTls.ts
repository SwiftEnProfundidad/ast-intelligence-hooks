...
const isTlsRejectUnauthorizedFalseOptionNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
...
const isTlsEnvRejectUnauthorizedZeroOverrideNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
