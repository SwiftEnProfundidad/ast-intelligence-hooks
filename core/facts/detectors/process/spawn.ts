...
const isCallByName = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>, expectedName: string): boolean => {
...
const isSpawnSyncCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
  return isCallByName(value, 'spawnSync');
};

const isSpawnCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
  return isCallByName(value, 'spawn');
};

const isForkCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
  return isCallByName(value, 'fork');
};

const isExecFileSyncCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
  return isCallByName(value, 'execFileSync');
};

const isExecFileCallNode = (value: Record<string, string | number | boolean | bigint | symbol | null | Date | object>): boolean => {
