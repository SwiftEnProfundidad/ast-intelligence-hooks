...
McpProtocolHandler.prototype.sendNotificationMessage = function sendNotificationMessage(level, message) {
    const payload = {
        jsonrpc: '2.0',
...
McpProtocolHandler.prototype.start = function start(messageHandler) {
...
McpProtocolHandler.prototype._handleChunk = async function _handleChunk(chunk, messageHandler) {
...
McpProtocolHandler.prototype.extractMessages = function extractMessages() {
    const messages = [];
...
McpProtocolHandler.prototype.writeResponse = function writeResponse(response, framed, delimiter) {
    const responseStr = JSON.stringify(response);
...
McpProtocolHandler.prototype.createInitializeResponse = function createInitializeResponse(id) {
    return {
        jsonrpc: '2.0',
        id: id,
        result: {
...
McpProtocolHandler.prototype.createErrorResponse = function createErrorResponse(id, code, message) {
    return {
        jsonrpc: '2.0',
        id: id,
        error: {
