// SwiftUI - PreferenceKeyPerformanceRule
import Foundation
import SourceKittenFramework
import SwiftLintCore

public struct PreferenceKeyPerformanceRule: SwiftLintRule {
    public static let description = RuleDescription(identifier: "swiftui_LPreference_LKey_LPerformance", name: "SwiftUI - PreferenceKeyPerformanceRule", description: "SwiftUI validation", kind: .lint)
    public init() {}
